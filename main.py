...
eval_comand_GMM02 = f"python evaluation.py --noise_type {noise_type } --noised_rate {noised_rate_02}  --model_name_or_path {model_save_path_GMM02} --pretrained_model_name_or_path {pretrained_model_name_or_path} --eval_file_path {eval_file_path} --dataset_name {dataset_name} --batch_size {batch_size}  --selection_strategy {selection_strategy_GMM}"

eval_comand_GMM_04 = f"python evaluation.py --noise_type {noise_type } --noised_rate {noise_rate_04} --model_name_or_path {model_save_path_GMM_04} --pretrained_model_name_or_path {pretrained_model_name_or_path} --eval_file_path {eval_file_path} --dataset_name {dataset_name} --batch_size {batch_size}  --selection_strategy {selection_strategy_GMM}"
